...
4. Add `RESEND_API_KEY` and `RESEND_FROM_EMAIL` for signup confirmation email.
5. In the Supabase SQL editor, run `supabase/migrations/0001_init.sql`.
...
- `/auth/confirm` - Resend-delivered signup confirmation callback
