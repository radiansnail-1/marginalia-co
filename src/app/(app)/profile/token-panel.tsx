...
export function TokenPanel() {
  ...
  return (
    <section className="mt-8 rounded-md bg-mahogany-2 p-5 ring-1 ring-brass/20">
      <div className="font-display text-sm uppercase tracking-widest text-brass">Connect your tools</div>
      ...
      <p className="mt-4 text-[10px] uppercase tracking-widest text-parchment-dim">
        Docs at <a href="/api/v1" className="text-brass-bright underline">/api/v1</a>
      </p>
    </section>
  );
}
