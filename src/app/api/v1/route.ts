...
export function GET() {
  return NextResponse.json({
    ...
    endpoints: [
      ...
      { method: "POST", path: "/api/v1/books", body: { title: "string", author: "string", status: "pile|reading|finished|abandoned", rating: "0.5-5 in 0.5 increments (optional)", googleBooksId: "optional", isbn13: "optional", pageCount: "optional", publishedYear: "optional", coverUrl: "optional", startedAt: "ISO (optional)", finishedAt: "ISO (optional)" } },
